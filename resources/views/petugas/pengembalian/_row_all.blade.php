@php
    ...
    if ($pinjam->tipe_pinjam == 'hari') {
        ...
        // Langsung parse jam_kembali dan format jadi "06 Apr 2026 10:30"
        $tglKembaliText = \Carbon\Carbon::parse($pinjam->jam_kembali)->format('d M Y H:i');
    }
...
<tr class="hover:bg-indigo-50 transition-colors">
    ...
    <td class="px-6 py-4">
        <span class="font-mono text-sm">{{ $pinjam->kode_peminjaman ?? '-' }}</span>
    </td>
    <td class="px-6 py-4">
