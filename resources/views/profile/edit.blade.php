<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-2 sm:mt-0 flex items-center space-x-2 text-sm bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 px-4 py-2 rounded-lg">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
                <div class="bg-gradient-to-r from-purple-600 via-fuchsia-500 to-pink-500 px-8 py-10 text-white">
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4 mt-2 flex-wrap gap-y-2">
                                <div class="flex items-center space-x-1 text-purple-100">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="text-sm text-purple-100">Member since {{ Auth::user()->created_at->format('d M Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="p-6">
                            <form method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="col-span-2 md:col-span-1">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="block w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-gray-50/50 focus:bg-white focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all"
                                                   required>
                                        </div>
                                        @error('name')
                                    ...
                                    <!-- Kelas (untuk siswa) -->
                                    @if(Auth::user()->role == 'siswa' && Auth::user()->kelas)
                                    <div class="col-span-2 md:col-span-1">
                                        ...
                                        <p class="mt-2 text-xs text-gray-500">Kelas tidak dapat diubah</p>
                                    </div>
                                    @endif
                                </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-5">
                                <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                    ...
                                    <span class="px-4 py-1.5 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 rounded-lg text-xs font-semibold capitalize">
                                        {{ Auth::user()->role }}
                                    </span>
                                </div>
